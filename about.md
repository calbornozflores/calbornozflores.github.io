...
I'm Claudio, a mathematician who moved into data science and never looked back.
I'm based in Santiago, Chile, originally from Padre Las Casas, La Araucanía — a region I still go back to regularly to mentor and give talks at my alma mater, Universidad de La Frontera.
...
My philosophy is simple: elegant solutions over complicated ones. I've seen too many pipelines fail under their own weight. I believe the best models are the ones that are maintainable, explainable, and actually ship.
...
<div class="row">
  <div class="container" style="width:auto;height:auto">
    <img class="left" src="/assets/minimal-mistakes/spark-summit.jpeg" alt="Spark Summit San Francisco 2019" style="border-radius:6px;">
    <div style="clear: both"></div>
  </div>
</div>
~~~

*At Spark Summit, San Francisco (2019).*
